...
In order to know the correspondence between the names of the samples that we previously selected from different databases (HGDP and 1000Genomes) and the names of the samples in this new database (Wohns et al., 2021), the following steps are necessary:
