...
popnames <- "1KG_CLM_PUR_FRN_SAR_ADY_RUS_ESN_MZB_HZP_KLS_MAN_MSL_IBS_BAS_PEL_PTH_CEU_MXL"

table <- read.table(paste("human_chr12_2",popnames,".tsv",sep=""),header=TRUE,nrows=83242)
